...
public class RVA_Subparts extends RecyclerView.Adapter<View_Holder>{
    ...
    public RVA_Subparts( List<Data> list, Context context) {
        ...
        holder.setClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                if(isLongClick){
                    ...
                    holder_.intentSubParts(Title, subTitle, Desc);
                }
                else {
                    Title = list.get(position).Title;
                    subTitle = list.get(position).subTitle;
